...
export const initialEmergencyResources: EmergencyResource[] = [
  {
    ...
    quantity: 75,
    unit: "meal kits",
    availabilityNote: "Prepared meals and dry food packages available for affected families.",
    operatingHours: "8:00 AM - 11:00 PM",
    status: "Limited",
    isPublished: true,
    latitude: 43.7403,
  ...
  },
  {
    ...
    city: "Scarborough, ON",
    contactNumber: "416-555-0199",
    quantity: 120,
    unit: "bottles",
    availabilityNote: "Bottled water available for pickup during the emergency response window.",
    operatingHours: "24 hours",
    status: "Open",
    isPublished: true,
    latitude: 43.7756,
  ...
  {
    id: "emergency-resource-3",
    name: "Mobile Community Clinic",
    category: "Medical",
    address: "Lawrence Avenue East",
    city: "Scarborough, ON",
    contactNumber: "416-555-0133",
    quantity: 20,
    unit: "care slots",
    availabilityNote: "First aid and basic wellness checks are available.",
